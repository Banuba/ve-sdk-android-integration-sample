...
| **showEditorConfig** | true/false | setups the button called "Show config" that opens a helper view with all `EditorConfig` properties. *Do not forget to setup false for production build*.
