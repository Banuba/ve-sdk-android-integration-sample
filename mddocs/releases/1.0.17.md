...
10. Parameter `supportsTextOnVideo` was added inside [EditorConfig](https://github.com/Banuba/ve-sdk-android-integration-sample/blob/main/mddocs/config_videoeditor.md) class to toggle text on video feature. By default the feature is **available.**