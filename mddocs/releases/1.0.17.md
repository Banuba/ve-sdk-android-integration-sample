...
2. New **Drafts** screen is available from the gallery screen, here is the [guide](https://github.com/Banuba/ve-sdk-android-integration-sample/blob/main/mddocs/gallery_styles.md) on how to customize the gallery and drafts screens. 
