...
| **startFrontFacingFirst** | true/false | *true* means that on the first launch of the camera screen the *front* camera is turned on, *false* means that on the first launch of the camera screen the *back* camera is turned on
